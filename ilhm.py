...
def logo():
	...
	print """
\033[1;91m[] --------------------------------- []  
\033[0;91m    _ __ _   __ ___   ____
\033[0;91m   /// // \,' // o.) / __/
\033[0;93m  / ` // \,' // o \ / _/  
\033[0;93m /_n_//_/ /_//___,'/_/
\033[1;93m[] --------------------------------- [] 
\033[1;94mcoded:BY RHMDJR :) """
...
def login():
	...
	try:
		...
		print(" ? ketik '\033[0;92mhelp\033[0;97m' untuk lihat tutorial ambil token facebook")
		token = raw_input("\n + token fb : ")
		if token == "help":
...
def pilih():
	hmzxyz = raw_input("\033[1;95m-----> \033[91m:\033[1;94m ")
	if hmzxyz =="":
		print"\033[1;94m{\033[1;91m!\033[1;93m}\033[1;95m Isi Yg Benar !"
		pilih()
		...
		print"\033[1;91m{\033[1;91m!\033[1;91m}\033[1;91m Isi Yg Benar !"
		pilih()
